            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Puedes consultar preguntas realizadas en Stackoverflow segun un tag que se le envia, por defecto salen las ultimas 30 preguntas que se han realizado.</p>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Puedes consultar el historial de preguntas realizadas en api-query/questions y luego poder seleccionar alguna para recuperar la respuesta de la BD.</p>
